...
export class Atualizacao21776738843461 implements MigrationInterface {
    name = 'Atualizacao21776738843461'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`rota\` ADD \`nome\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`rota\` ADD \`tipo\` varchar(255) NOT NULL DEFAULT 'COMUM'`);
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` DROP FOREIGN KEY \`FK_387e05397ff768beab61de90396\``);
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` CHANGE \`listaId\` \`listaId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` DROP FOREIGN KEY \`FK_f86ce1799b64dbc1c19a02da56e\``);
        ...
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` CHANGE \`listaId\` \`listaId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` ADD CONSTRAINT \`FK_387e05397ff768beab61de90396\` FOREIGN KEY (\`listaId\`) REFERENCES \`lista\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_f86ce1799b64dbc1c19a02da56e\` FOREIGN KEY (\`listaId\`) REFERENCES \`lista\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` CHANGE \`listaId\` \`listaId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` CHANGE \`dataGeracao\` \`dataGeracao\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_6427001841eb49957c4c7d8641b\` FOREIGN KEY (\`rotaId\`) REFERENCES \`rota\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_825f9e5534f420ae68d98e5d169\` FOREIGN KEY (\`motoristaId\`) REFERENCES \`motorista\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`atribuicao_final\` ADD CONSTRAINT \`FK_f86ce1799b64dbc1c19a02da56e\` FOREIGN KEY (\`listaId\`) REFERENCES \`lista\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`ordem_joinha\` CHANGE \`listaId\` \`listaId\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`administrador\` CHANGE \`dataDeEdicao\` \`dataDeEdicao\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`administrador\` CHANGE \`dataDeRegistro\` \`dataDeRegistro\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`rota\` DROP COLUMN \`tipo\``);
        await queryRunner.query(`ALTER TABLE \`rota\` DROP COLUMN \`nome\``);
    }
