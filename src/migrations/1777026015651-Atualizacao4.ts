...
export class Atualizacao41777026015651 implements MigrationInterface {
    name = 'Atualizacao41777026015651'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`empresa\` ADD \`logo\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`passageiro\` ADD \`telefoneWhatsApp\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`passageiro\` DROP COLUMN \`telefoneWhatsApp\``);
        await queryRunner.query(`ALTER TABLE \`empresa\` DROP COLUMN \`logo\``);
    }
