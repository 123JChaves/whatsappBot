...
export class Atualizacao61777029829970 implements MigrationInterface {
    name = 'Atualizacao61777029829970'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`passageiro\` ADD \`solicitacao\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`passageiro\` DROP COLUMN \`solicitacao\``);
    }
